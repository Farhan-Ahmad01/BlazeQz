package com.example.blazeqz.data.util

object Constant {

    const val BASE_URL = "http://blazeqz.eu-north-1.elasticbeanstalk.com"
    ...
    const val QUESTIONS_COUNT_TABLE_NAME = "questions_count"
    const val USER_ANSWER_TABLE_NAME = "user_answers"

    const val DATA_STORE_FILE_NAME = "blazeqz.preferences"
